...
def run_npvis(in_spectrum, scanId, in_structure):
    os.system(f'{PRINT_SCORE_PATH}/print_score -C {PRINT_SCORE_PATH}/../share/npdtools/ {in_spectrum} {in_structure} --print_matches --print_spectrum --blind_search --scan_num {scanId} > {DATA_PATH}/psm.ann')
